...
- [x] **Tarefa 1.1**: Criar rotina de migração para a tabela `sessions`.
...
- [x] **Tarefa 2.1**: Implementar queries SQL de Agregações de Dashboard.
  - **Instruções**:
...
- [x] **Tarefa 2.2**: Implementar Handlers de Estatísticas e Gráficos no Go.
  - **Instruções**:
...
- [x] **Tarefa 2.3**: Implementar Handler de Transações Financeiras Recentes.
...
- [x] **Tarefa 3.1**: Integrar Cards de KPI do Dashboard.
...
- [x] **Tarefa 3.2**: Integrar Gráficos no Dashboard.
...
- [x] **Tarefa 3.3**: Integrar Tabela de Transações Financeiras.
